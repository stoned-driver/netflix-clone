...
interface Props {
    title: string
    movies: Movie[]
    // movies: Movie[] | DocumentData[] TODO: when using firebase
}
    ...
    return (
        <div className="h-40 space-y-0.5">
            ...
            <div className="group relative md:-ml-2">
                <ChevronLeftIcon
                    className={`absolute top-0 bottom-0 left-2 z-40 m-auto w-9 h-9 cursor-pointer
                ...
                <ChevronRightIcon className={`absolute top-0 bottom-0 right-2 z-40 m-auto w-9 h-9 cursor-pointer
